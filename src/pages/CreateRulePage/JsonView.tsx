    ...
    <Stack gap="md">
      ...
      <Paper p="md" withBorder>
        <Group justify="space-between">
          ...
          <Button variant="light" leftSection={<IconArrowLeft size={16} />} onClick={onBackToForm}>
            Back to Form
          </Button>
        </Group>
      </Paper>
      ...
      <Group>
        ...
        <Button leftSection={<IconFileImport size={16} />} variant="light" onClick={handleImport}>
          Import from Clipboard
        </Button>
      </Group>
      ...
      {jsonError ? (
        <Alert color="red" title="❌ Syntax Error">
          ...
          {liveSync && (
            <Text size="sm" mt="xs">
              Fix the JSON syntax and it will sync after 500ms
            </Text>
          )}
        </Alert>
      ) : (
